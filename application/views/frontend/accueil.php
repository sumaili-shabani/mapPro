...
<?php include('_nav.php') ?>
							...
							<div class="container">
								...
								<form class="col-md-12 row" id="ServiceRequest" action="<?php echo(base_url()) ?>" method='post'>
				                    ...
				                    <div class="col-md-3 col-sm-12 text-left">
				                    	 <label><i class="fa fa-save"></i> Effectuer une action</label>
				                        <input id="ProviderId" name="ProviderId" type="hidden" value="" />
					                        <input id="lat" type="hidden" value="" />
					                        <input id="lng" type="hidden" value="" />
					                        
					                        <button type="button" class="btn btn-warning btn-round" onclick="RelatedLocationAjax();"><i class="fa fa-send"></i> fultrer votre requête</button>
				                    </div>
				                    ...
				                    <div class="col-md-12 col-sm-12">
				                        ...
				                        <!-- display map  !-->
				                        <div class="embed-responsive embed-responsive-21by9" id="map" style="height: 600px;" class="col-md-12"></div>
  	...
  	<script type="text/javascript">
	    ...
	    function RelatedLocationAjax() {
	        $.ajax({
	            type: "POST",
	            url: "<?php echo(base_url()) ?>home/closest_locations",
	            dataType: "json",
