                ...
                if (navigator.geolocation) {
                    navigator.geolocation.getCurrentPosition(function (position){
                        ...
                        $.ajax({
                            ...
                            url:"<?php echo(base_url()) ?>user/liste_simple",
                            type:"GET",
                            crossDomain: true,
                            dataType: "json",
                            cache: false,
                            success:function(result){
                                ...
                                $.each(result, function(i, jsonObject){
                                    ...
                                    marker.bindPopup(''+jsonObject['fullname']+'<a href="<?php echo(base_url()) ?>user/detail_hopital_profile/'+user_id+'"><br> <i class="fa fa-eye"></i>cliquer et voir le détail</a><br><img src="<?php echo(base_url()) ?>upload/tbl_info/'+icone+'" width="150" height="100" />');
                                })
                            },
                            error:function(err){
                                // alert(err.toString());
