  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="<?php echo(base_url()) ?>user/accueil"><i class="fa fa-home"></i> Accueil <span class="sr-only"></span></a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="<?php echo(base_url()) ?>user/map_plus"><i class="fa fa-map"></i> Itinéraire </a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="<?php echo(base_url()) ?>user/publication"><i class="fa  fa-road"></i> Publication</a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="<?php echo(base_url()) ?>user/calendrier"><i class="fa  fa-calendar"></i> Nos Programmes</a>
      </li>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
           ...
           ?>
            ...
            <a class="dropdown-item text-center" href="<?php echo(base_url()) ?>user/notification_all"><i class="fa  fa-bell"></i> Voir les <code class="text-warning" style="font-size: 20px;"><?php echo($nombre_de_notification) ?></code> notifications</a>
          ...
          <?php
           ...
           if ($message->num_rows() > 0) {
            ...
            foreach ($message->result_array() as $not5) {
              ...
              <a class="dropdown-item media bg-flat-white" href="<?php echo(base_url()) ?>user/chat_admin/<?php echo($connected) ?>/<?php echo($not5['id_user']) ?>">
           ...
           ?>
            ...
            <a class="dropdown-item text-center" href="<?php echo(base_url()) ?>user/message"><i class="fa  fa-comments-o"></i> Voir les <code class="text-warning" style="font-size: 20px;"><?php echo($nombre_de_message) ?></code> messages</a>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" href="<?php echo(base_url()) ?>user/basic"><i class="fa  fa-gears"></i> Paramètre</a>
          <div class="dropdown-divider"></div>
