...
$(document).ready(function(){
 ...
 {
  $.ajax({
   url:"<?php echo base_url(); ?>user/pagination_access_formation_to_learn/"+page,
   method:"GET",
   dataType:"json",
 ...
 {
    $.ajax({
     url:"<?php echo base_url(); ?>user/fetch_search_formation_to_learn",
     method:"POST",
     data:{query:query},
     success:function(data){
 ...
 $(document).on('click','.voir_plus', function(e){
  ...
  $.ajax({
    url: "<?php echo base_url(); ?>user/view_fetch_search_auditor_one",
    method:"POST",
    data:{
...
$(document).on('click','.brand', function(){
  ...
  $.ajax({
    url:"<?php echo base_url(); ?>user/view_all_product_by_cat",
    method: "POST",
    data:{
      brand: brand
    },
