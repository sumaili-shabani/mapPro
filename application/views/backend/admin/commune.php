  ...
  <body>
					...
					<div class="col-md-12" style="margin-top: 10px;">
						...
						<div class="row">
							...
							<div class="col-md-8">
								...
								<!-- debut -->
			                    <div class="col-md-12">
			                        <strong class="card-title">parametrage des communes de la ville </strong>
		                                ...
		                                <table id="user_data" class="table table-bordered table-striped">
		                                        <thead>  
		                                            <tr>  
		                                                 ...
		                                                 <th width="40%">Nom de la commune</th>  
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group col-md-12">
                     <label> <i class="fa fa-edit"></i> Entrer le nom de la commune</label>
                     <input type="text" name="nom" id="nom" class="form-control" placeholder="Entrez le nom de la commune" />
                </div>
     ...
     $(document).ready(function(){  
          $('#add_button').click(function(){  
               $('#user_form')[0].reset();  
               $('.modal-title').text("Paramètrage des communes de la ville");  
               $('#action').val("Add");  
          })  
          ...
          $(document).on('click', '.update', function(){  
               ...
               $.ajax({  
                    ...
                    {  
                         ...
                         $('.modal-title').text("modification de la commune "+data.nom);  
                         $('#idcat').val(idcat);   
                         $('#action').val("Edit");  
                    }  
               });  
