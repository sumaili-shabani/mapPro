<div class="col-md-12">
	...
	<!-- form commence -->
	<form method="post" id="user_form" enctype="multipart/form-data" action="<?= base_url(); ?>admin/modification_panel/option1">
	<div class="col-lg-12">
		<div class="row">
	        ...
	        <div class="col-md-12">
	        	<label class="label-control"><i class="fa fa-question-circle"></i>Complèter votre biographie</label>
	        	 ...
	        	 <textarea name="biographie" class=" form-control" placeholder="Parler un peu de vous, surtout ce que tu fais dans la vie et quelle personnalité tu occupe dans la société"
                  >
                  	<?php echo($biographie) ?>
                  </textarea>
	           <div class="col-md-12">
	        ...
	        <div class="col-md-12">
	        	<div class="form-group">
	        		...
	        		<input type="submit" name="action" id="action" class="btn btn-warning btn-round pull-right" value="modifier" />
	        	</div>
	        </div>
