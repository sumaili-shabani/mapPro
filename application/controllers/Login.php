...
class login extends CI_Controller
{
	...
	public function index(){
		$data["title"] = "Connexion au système map santé nord kivu";  
		$this->load->view('login', $data);
		// $this->load->view('panel', $data);
	}
	public function register(){
		$data["title"] = "Devenez de à présent membre au système map santé nord kivu professionnel";  
		$this->load->view('register', $data);
	}
	public function forgot(){
		$data["title"] = "Avez-vous oublié votre mot de passe au système map santé nord kivu professionnel";  
    ...
    function recuperaion_password(){
        ...
        if($this->form_validation->run())
        {
            ...
            if($result == '')
            {
                ...
                $website = "info@mapsante.com";

                $to =$this->input->post('user_email');
                $subject = "votre mot de passe de recupération au compte system map santé";
                $message2 = "
                <p>Salut!!! voici votre code de recupération de votre mot de passe au système de map santé ".$verification_key." cliquer sur ce lien pour changer votre nouveau mot de passe <a href='".base_url()."login/change_secure/".$verification_key."'>changer mon mot de passe</a>.</p>
